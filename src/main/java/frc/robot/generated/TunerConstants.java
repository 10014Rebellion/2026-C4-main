...
public class TunerConstants {
    private static double driveKP = 0.1;
    private static double driveKD = 0.1;
    private static double driveKS = 0.1;
    private static double driveKV = 0.1;
    private static double driveKA = 0.1;

    private static double azimuthKP = 0.1;
    private static double azimuthKD = 0.1;
    private static double azimuthKS = 0.1;
    private static double azimuthKV = 0.1;
    private static double azimuthKA = 0.1;
    
    private final LoggedTunableNumber loggedDriveKP = new LoggedTunableNumber("Drive/kP", driveKP);
    private final LoggedTunableNumber loggedDriveKD = new LoggedTunableNumber("Drive/kD", driveKD);
    private final LoggedTunableNumber loggedDriveKS = new LoggedTunableNumber("Drive/kS", driveKS);
    private final LoggedTunableNumber loggedDriveKV = new LoggedTunableNumber("Drive/kV", driveKV);
    private final LoggedTunableNumber loggedDriveKA = new LoggedTunableNumber("Drive/kA", driveKA);
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(4.5).withKI(0).withKD(0).withKS(0).withKV(0.5);
